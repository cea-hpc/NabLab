...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nabla.Comparison} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComparisonItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comparison_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comparison_op_feature", "_UI_Comparison_type"),
				 NablaPackage.Literals.COMPARISON__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NablaPackage.Literals.COMPARISON__LEFT);
			childrenFeatures.add(NablaPackage.Literals.COMPARISON__RIGHT);
		}
	...
	public String getText(Object object) {
		String label = ((Comparison)object).getOp();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comparison.class)) {
			case NablaPackage.COMPARISON__OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case NablaPackage.COMPARISON__LEFT:
			case NablaPackage.COMPARISON__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NablaPackage.Literals.COMPARISON__LEFT ||
			childFeature == NablaPackage.Literals.COMPARISON__RIGHT;
