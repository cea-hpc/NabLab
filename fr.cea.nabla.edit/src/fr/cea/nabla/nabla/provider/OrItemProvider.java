...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nabla.Or} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_op_feature", "_UI_Or_type"),
				 NablaPackage.Literals.OR__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NablaPackage.Literals.OR__LEFT);
			childrenFeatures.add(NablaPackage.Literals.OR__RIGHT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Or.class)) {
			case NablaPackage.OR__OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case NablaPackage.OR__LEFT:
			case NablaPackage.OR__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NablaPackage.Literals.OR__LEFT ||
			childFeature == NablaPackage.Literals.OR__RIGHT;
