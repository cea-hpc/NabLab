...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nabla.Plus} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlusItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plus_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plus_op_feature", "_UI_Plus_type"),
				 NablaPackage.Literals.PLUS__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NablaPackage.Literals.PLUS__LEFT);
			childrenFeatures.add(NablaPackage.Literals.PLUS__RIGHT);
		}
	...
	public String getText(Object object) {
		String label = ((Plus)object).getOp();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Plus.class)) {
			case NablaPackage.PLUS__OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case NablaPackage.PLUS__LEFT:
			case NablaPackage.PLUS__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NablaPackage.Literals.PLUS__LEFT ||
			childFeature == NablaPackage.Literals.PLUS__RIGHT;
