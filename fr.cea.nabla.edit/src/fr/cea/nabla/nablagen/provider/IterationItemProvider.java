...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nablagen.Iteration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterationItemProvider extends PersistencePeriodItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NablagenPackage.Literals.ITERATION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Iteration_type") + " " + iteration.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Iteration.class)) {
			case NablagenPackage.ITERATION__VALUE:
