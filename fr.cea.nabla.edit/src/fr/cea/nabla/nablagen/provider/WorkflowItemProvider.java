...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nablagen.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNablaModulePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NablagenPackage.Literals.WORKFLOW__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Nabla Module feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNablaModulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_nablaModule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_nablaModule_feature", "_UI_Workflow_type"),
				 NablagenPackage.Literals.WORKFLOW__NABLA_MODULE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NablagenPackage.Literals.WORKFLOW__COMPONENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Workflow.class)) {
			case NablagenPackage.WORKFLOW__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case NablagenPackage.WORKFLOW__COMPONENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createWorkflowComponent()));
		...
		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createNabla2IrComponent()));

		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createTagPersistentVariablesComponent()));
		...
		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createOptimizeConnectivitiesComponent()));

		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createFillHLTsComponent()));

		newChildDescriptors.add
			(createChildParameter
				(NablagenPackage.Literals.WORKFLOW__COMPONENTS,
				 NablagenFactory.eINSTANCE.createIr2JavaComponent()));
