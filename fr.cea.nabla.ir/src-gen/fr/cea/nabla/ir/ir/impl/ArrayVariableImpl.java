 ...
 *   <li>{@link fr.cea.nabla.ir.ir.impl.ArrayVariableImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayVariableImpl extends VariableImpl implements ArrayVariable {
	...
	public VarRef getDefaultValue() {
		if (defaultValue != null && defaultValue.eIsProxy()) {
			...
			if (defaultValue != oldDefaultValue) {
				...
				NotificationChain msgs = oldDefaultValue.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, null, null);
				if (newDefaultValue.eInternalContainer() == null) {
					msgs = newDefaultValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
			}
		}
		return defaultValue;
	}
	...
	public NotificationChain basicSetDefaultValue(VarRef newDefaultValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(VarRef newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IrPackage.ARRAY_VARIABLE__DEFAULT_VALUE:
