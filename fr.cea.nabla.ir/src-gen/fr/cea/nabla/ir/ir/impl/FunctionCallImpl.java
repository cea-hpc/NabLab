 ...
 * </p>
 * <ul>
 *   <li>{@link fr.cea.nabla.ir.ir.impl.FunctionCallImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link fr.cea.nabla.ir.ir.impl.FunctionCallImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionCallImpl extends ExpressionImpl implements FunctionCall {
	...
	public EList<Expression> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<Expression>(Expression.class, this, IrPackage.FUNCTION_CALL__ARGS);
		}
		return args;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IrPackage.FUNCTION_CALL__ARGS:
