...
class JobDependencyBuilder 
{
	static val TimeLoopSourceNodeLabel = 'TimeLoopSourceNode'
	static val GlobalSourceNodeLabel = 'GlobalSourceNode'

	/**
	 * Prend en paramètre une instance de NablaIrFile et renseigne l'attribut @ des jobs
	...
	def fillAt(IrModule file)
	{
		...
		val g = file.createGraph(globalSourceNode, timeLoopSourceNode)
