...
class ReplaceExternalReductions implements IrTransformationStep
{
	...
	private def createReductionLoop(Iterator iterator, Variable affectationLHS, Expression affectationRHS, String op)
	{
