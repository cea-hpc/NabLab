 ...
 *******************************************************************************/
#ifndef LINEARALGEBRA_SYCL_MATRIX_H_
#define LINEARALGEBRA_SYCL_MATRIX_H_
...
#include "linearalgebra/sycl/CrsMatrix.h"
...
class NablaSparseMatrix
{
 ...
 //private:
  ...
  cl::sycl::buffer<double, 2> m_a;
};

}
#endif /* LINEARALGEBRA_SYCL_MATRIX_H_ */
