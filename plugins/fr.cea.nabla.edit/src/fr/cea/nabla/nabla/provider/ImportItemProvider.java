...
/**
 * This is the item provider adapter for a {@link fr.cea.nabla.nabla.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NablaPackage.Literals.IMPORT__IMPORTED_NAMESPACE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Import.class)) {
			case NablaPackage.IMPORT__IMPORTED_NAMESPACE:
