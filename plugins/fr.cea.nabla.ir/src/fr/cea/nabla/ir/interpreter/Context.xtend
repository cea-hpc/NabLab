...
class Context
{
	...
	val dimensionValues = new HashMap<SimpleVariable, Integer>
	...
	// DimensionValues
	def int getDimensionValue(SimpleVariable it)
	{
		dimensionValues.get(it) ?: outerContext.getDimensionValue(it)
	}

	def addDimensionValue(SimpleVariable it, int value)
	{
		dimensionValues.put(it, value)
	}

	def void setDimensionValue(SimpleVariable it, int value)
	{
