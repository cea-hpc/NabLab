...
/**
 * The data fetcher used to rename an object.
 *
 * @author arichard
 */
...
public class MutationEditLabelDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationEditLabelDataFetcher(ObjectMapper objectMapper, IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        return this.editingContextEventProcessorRegistry.dispatchEvent(input.getEditingContextId(), input)
                .defaultIfEmpty(new ErrorPayload(input.getId(), "Unable to rename")) //$NON-NLS-1$
                .toFuture();
        // @formatter:on
    }
}
