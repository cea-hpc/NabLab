...
package simplemeshexamplewithfunction;
...
public final class SimpleMeshExampleWithFunction
{
	...
	public SimpleMeshExampleWithFunction(CartesianMesh2D aMesh)
	{
	...
	public void jsonInit(final String jsonContent)
	{
		...
		writer = new PvdFileWriter2D("SimpleMeshExampleWithFunction", outputPath);
	...
	protected void computeSum()
	{
		IntStream.range(0, nbCells).parallel().forEach(jCells -> 
		{
			...
			nodes_sum[jCells] = reduction0 + addZero(0);
		});
	}
	...
	private static double addZero(int a)
	{
		return a + 0.0;
	}
	...
	{
		System.out.println("Start execution of simpleMeshExampleWithFunction");
		computeCst(); // @1.0
		initTime(); // @1.0
		computeSum(); // @2.0
		setUpTimeLoopN(); // @2.0
		...
		System.out.println("End of execution of simpleMeshExampleWithFunction");
	}
	...
	public static void main(String[] args) throws IOException
	{
		if (args.length == 1)
		{
			...
			SimpleMeshExampleWithFunction simpleMeshExampleWithFunction = new SimpleMeshExampleWithFunction(mesh);
			if (o.has("simpleMeshExampleWithFunction")) simpleMeshExampleWithFunction.jsonInit(o.get("simpleMeshExampleWithFunction").toString());
		...
		else
		{
			...
			System.err.println("        Expecting user data file name, for example SimpleMeshExampleWithFunction.json");
			System.exit(1);
		}
	}
