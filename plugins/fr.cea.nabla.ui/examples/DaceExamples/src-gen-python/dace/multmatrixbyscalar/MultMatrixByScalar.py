...
AddJob_a = mysdfg.add_array('AddJob_a', [6,4], dp.float64)
AddJob_b = mysdfg.add_array('AddJob_b', [6,4], dp.float64)

map_entry, map_exit = AddJob.add_map('AddJob_map', dict(i0='0:6',i1='0:4'))
