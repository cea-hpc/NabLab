...
if __name__ == '__main__':
	...
	if len(args) == 1:
		...
		simpleMeshExampleWithFunctionData = data["simpleMeshExampleWithFunction"]
		if (simpleMeshExampleWithFunctionData):
			simpleMeshExampleWithFunction.jsonInit(simpleMeshExampleWithFunctionData)
