...
void Glace2dModule::computeBoundaryConditions()
{
	...
	arcaneParallelForeach(mesh()->findGroup("BottomNodes"), [&](NodeVectorView view)
	{
	...
	arcaneParallelForeach(mesh()->findGroup("LeftNodes"), [&](NodeVectorView view)
	{
...
{
	arcaneParallelForeach(mesh()->findGroup("InnerNodes"), [&](NodeVectorView view)
	{
