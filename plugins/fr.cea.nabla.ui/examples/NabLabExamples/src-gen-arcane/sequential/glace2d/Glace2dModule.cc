...
{
	m_t_n = m_t_n0;
	ENUMERATE_NODE(i1Nodes, allNodes())
	{
...
void Glace2dModule::computeBoundaryConditions()
{
	...
	ENUMERATE_NODE(rRightNodes, NodeGroup(m_mesh->getGroup("RightNodes")))
	{
...
{
	ENUMERATE_NODE(rInnerNodes, NodeGroup(m_mesh->getGroup("InnerNodes")))
	{
