 ...
 */
void IterativeHeatEquation::init_deltat() noexcept
{
	deltat = 0.001;
}

/**
 * Job init_epsilon called @1.0 in simulate method.
 * In variables: 
 * Out variables: epsilon
 */
void IterativeHeatEquation::init_epsilon() noexcept
{
	// epsilon
	rapidjson::Value::Object options = jsonDocument.GetObject();
 ...
 */
void IterativeHeatEquation::init_lastDump() noexcept
{
 ...
 */
void IterativeHeatEquation::init_maxIterations() noexcept
{
	// maxIterations
	rapidjson::Value::Object options = jsonDocument.GetObject();
...
/**
 * Job init_maxIterationsK called @1.0 in simulate method.
 * In variables: 
 * Out variables: maxIterationsK
 */
void IterativeHeatEquation::init_maxIterationsK() noexcept
{
	// maxIterationsK
	rapidjson::Value::Object options = jsonDocument.GetObject();
 ...
 */
void IterativeHeatEquation::init_outputPeriod() noexcept
{
	// outputPeriod
	rapidjson::Value::Object options = jsonDocument.GetObject();
 ...
 */
void IterativeHeatEquation::init_stopTime() noexcept
{
	// stopTime
	rapidjson::Value::Object options = jsonDocument.GetObject();
 ...
 * Out variables: u0
 */
void IterativeHeatEquation::init_u0() noexcept
{
	// u0
	rapidjson::Value::Object options = jsonDocument.GetObject();
...
void IterativeHeatEquation::simulate()
{
	...
	Kokkos::parallel_for(team_policy, KOKKOS_LAMBDA(member_type thread)
	{
		...
		initXc(thread);
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_deltat();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_epsilon();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_lastDump();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_maxIterations();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_maxIterationsK();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_outputPeriod();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_stopTime();});
		if (thread.league_rank() == 0)
			Kokkos::single(Kokkos::PerTeam(thread), KOKKOS_LAMBDA(){init_u0();});
	});
