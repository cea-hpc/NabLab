...
#include "batilib_BatiLibCppJni.h"
...
(JNIEnv *env, jobject self)
{
	...
	batilib::BatiLibCpp *o = new batilib::BatiLibCpp();
...
static batilib::BatiLibCpp* getObject
(JNIEnv *env, jobject self)
{
	...
	return reinterpret_cast<batilib::BatiLibCpp*>(nativeObjectPointer);
}
...
{
	batilib::BatiLibCpp* _self = getObject(env, self);
