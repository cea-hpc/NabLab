 ...
 *******************************************************************************/
#ifndef NABLALIB_MESH_KOKKOS_PVDFILEWRITER2D_H_
#define NABLALIB_MESH_KOKKOS_PVDFILEWRITER2D_H_
...
namespace nablalib::mesh::kokkos
{
...
public:
	...
	void write(const string& name, Kokkos::View<double*>& data)
	{
	...
	template<size_t N> void write(const string& name, Kokkos::View<RealArray1D<2>*>& data)
	{
		if (isDisabled()) return;
...
#endif /* NABLALIB_MESH_KOKKOS_PVDFILEWRITER2D_H_ */
