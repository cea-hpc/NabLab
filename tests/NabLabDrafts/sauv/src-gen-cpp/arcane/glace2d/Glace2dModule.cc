...
namespace glace2dfreefuncs
{
	...
	{
		UniqueArray2<Real> result(a.size(), a.size());
	...
	{
		UniqueArray<Real> result(a.dim1Size());
		for (Int32 ix=0; ix<a.dim1Size(); ix++)
		{
			UniqueArray<Real> tmp(a.dim2Size());
	...
	{
		UniqueArray2<Real> result(a.dim1Size(), a.dim2Size());
	...
	{
		UniqueArray2<Real> result(b.dim1Size(), b.dim2Size());
...
void Glace2dModule::init()
{
	...
	m_max_nb_cells_of_node = CartesianMesh2D::MaxNbCellsOfNode;
	m_nb_inner_nodes = m_mesh->getNbInnerNodes();
	m_nb_top_nodes = m_mesh->getNbTopNodes();
	m_nb_bottom_nodes = m_mesh->getNbBottomNodes();
	m_nb_left_nodes = m_mesh->getNbLeftNodes();
	m_nb_right_nodes = m_mesh->getNbRightNodes();

	// initialization of other attributes
	m_lastDump = numeric_limits<int>::min();
	m_n = 0;
	m_l.resize(m_max_nb_nodes_of_cell);
	m_Cjr_ic.resize(m_max_nb_nodes_of_cell);
	m_C.resize(m_max_nb_nodes_of_cell);
	m_F.resize(m_max_nb_nodes_of_cell);
	m_Ajr.resize(m_max_nb_nodes_of_cell);
		...
		ENUMERATE_CELL(jCells, view)
		{
			const auto jId(*jCells);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					...
					m_C[jCells][rNodesOfCellJ.localId()] = Real2(glace2dfreefuncs::operatorMult(0.5, Real2(glace2dfreefuncs::perp(Real2(glace2dfreefuncs::operatorSub(m_X_n[rPlus1Nodes], m_X_n[rMinus1Nodes]))))));
				}
			}
		}
	});
		...
		ENUMERATE_CELL(jCells, view)
		{
			const auto jId(*jCells);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					...
					const auto rPlus1Nodes(rPlus1Id);
					const auto rMinus1Nodes(rMinus1Id);
					m_Cjr_ic[jCells][rNodesOfCellJ.localId()] = Real2(glace2dfreefuncs::operatorMult(0.5, Real2(glace2dfreefuncs::perp(Real2(glace2dfreefuncs::operatorSub(m_X_n0[rPlus1Nodes], m_X_n0[rMinus1Nodes]))))));
				}
			}
		}
	});
	...
	arcaneParallelForeach(m_mesh->getCells(), [&](CellVectorView view)
	{
		ENUMERATE_CELL(jCells, view)
		{
			const auto jId(*jCells);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					m_l[jCells][rNodesOfCellJ.localId()] = glace2dfreefuncs::norm(m_C[jCells][rNodesOfCellJ.localId()]);
				}
			}
		}
	});
		...
		ENUMERATE_CELL(jCells, view)
		{
			...
			Real reduction0(0.0);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					...
					reduction0 = glace2dfreefuncs::sumR0(reduction0, glace2dfreefuncs::dot(m_C[jCells][rNodesOfCellJ.localId()], m_X_n[rNodes]));
				}
			}
		...
		ENUMERATE_CELL(jCells, view)
		{
			...
			Real reduction1(0.0);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					const auto rId(nodesOfCellJ[rNodesOfCellJ]);
					const auto rNodes(rId);
					reduction1 = glace2dfreefuncs::sumR0(reduction1, glace2dfreefuncs::dot(m_Cjr_ic[jCells][rNodesOfCellJ.localId()], m_X_n0[rNodes]));
				}
			}
...
{
	m_t_n = m_t_n0;
	arcaneParallelForeach(m_mesh->getNodes(), [&](NodeVectorView view)
	{
	...
	arcaneParallelForeach(m_mesh->getCells(), [&](CellVectorView view)
	{
		ENUMERATE_CELL(jCells, view)
		{
			const auto jId(*jCells);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					m_Ajr[jCells][rNodesOfCellJ.localId()] = Real2x2(glace2dfreefuncs::operatorMult(((m_rho[jCells] * m_c[jCells]) / m_l[jCells][rNodesOfCellJ.localId()]), Real2x2(glace2dfreefuncs::tensProduct(m_C[jCells][rNodesOfCellJ.localId()], m_C[jCells][rNodesOfCellJ.localId()]))));
				}
			}
		}
	});
	...
	arcaneParallelForeach(m_mesh->getCells(), [&](CellVectorView view)
	{
		ENUMERATE_CELL(jCells, view)
		{
			...
			Real reduction0(0.0);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					reduction0 = glace2dfreefuncs::sumR0(reduction0, m_l[jCells][rNodesOfCellJ.localId()]);
				}
			}
		...
		ENUMERATE_NODE(rNodes, view)
		{
			...
			Real2x2 reduction0{0.0, 0.0,  0.0, 0.0};
			{
				...
				for (Int32 jCellsOfNodeR=0; jCellsOfNodeR<nbCellsOfNodeR; jCellsOfNodeR++)
				{
					...
					const auto rNodesOfCellJ(indexOf(m_mesh->getNodesOfCell(jId), rId));
					reduction0 = Real2x2(glace2dfreefuncs::sumR2(reduction0, m_Ajr[jCells][rNodesOfCellJ.localId()]));
				}
			}
			for (Int32 i1=0; i1<2; i1++)
			{
		...
		ENUMERATE_NODE(rNodes, view)
		{
			...
			Real2 reduction0{0.0, 0.0};
			{
				...
				for (Int32 jCellsOfNodeR=0; jCellsOfNodeR<nbCellsOfNodeR; jCellsOfNodeR++)
				{
					...
					const auto jCells(jId);
					const auto rNodesOfCellJ(indexOf(m_mesh->getNodesOfCell(jId), rId));
					reduction0 = Real2(glace2dfreefuncs::sumR1(reduction0, Real2(glace2dfreefuncs::operatorAdd(Real2(glace2dfreefuncs::operatorMult(m_p[jCells], m_C[jCells][rNodesOfCellJ.localId()])), Real2(glace2dfreefuncs::matVectProduct(m_Ajr[jCells][rNodesOfCellJ.localId()], m_uj_n[jCells]))))));
				}
			}
			for (Int32 i1=0; i1<2; i1++)
			{
...
void Glace2dModule::computeDt()
{
	...
	ENUMERATE_CELL(jCells, m_mesh->getCells())
	{
...
{
	const Real2x2 I(Real2x2{1.0, 0.0, 0.0, 1.0});
	arcaneParallelForeach(m_mesh->getTopNodes(), [&](NodeVectorView view)
	{
	...
	arcaneParallelForeach(m_mesh->getBottomNodes(), [&](NodeVectorView view)
	{
	...
	arcaneParallelForeach(m_mesh->getLeftNodes(), [&](NodeVectorView view)
	{
	...
	arcaneParallelForeach(m_mesh->getRightNodes(), [&](NodeVectorView view)
	{
...
{
	arcaneParallelForeach(m_mesh->getInnerNodes(), [&](NodeVectorView view)
	{
		...
		ENUMERATE_CELL(jCells, view)
		{
			const auto jId(*jCells);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					const auto rId(nodesOfCellJ[rNodesOfCellJ]);
					const auto rNodes(rId);
					m_F[jCells][rNodesOfCellJ.localId()] = Real2(glace2dfreefuncs::operatorAdd(Real2(glace2dfreefuncs::operatorMult(m_p[jCells], m_C[jCells][rNodesOfCellJ.localId()])), Real2(glace2dfreefuncs::matVectProduct(m_Ajr[jCells][rNodesOfCellJ.localId()], (Real2(glace2dfreefuncs::operatorSub(m_uj_n[jCells], m_ur[rNodes])))))));
				}
			}
		}
	});
		...
		ENUMERATE_CELL(jCells, view)
		{
			...
			Real reduction0(0.0);
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					const auto rId(nodesOfCellJ[rNodesOfCellJ]);
					const auto rNodes(rId);
					reduction0 = glace2dfreefuncs::sumR0(reduction0, glace2dfreefuncs::dot(m_F[jCells][rNodesOfCellJ.localId()], m_ur[rNodes]));
				}
			}
	...
	arcaneParallelForeach(m_mesh->getCells(), [&](CellVectorView view)
	{
		ENUMERATE_CELL(jCells, view)
		{
			...
			Real2 reduction0{0.0, 0.0};
			{
				...
				for (Int32 rNodesOfCellJ=0; rNodesOfCellJ<nbNodesOfCellJ; rNodesOfCellJ++)
				{
					reduction0 = Real2(glace2dfreefuncs::sumR1(reduction0, m_F[jCells][rNodesOfCellJ.localId()]));
				}
			}
