...
{
	#pragma omp parallel for shared(v1_nplus1_k0)
	for (size_t cCells=0; cCells<nbCells; cCells++)
	{
...
{
	#pragma omp parallel for shared(v2_n0)
	for (size_t cCells=0; cCells<nbCells; cCells++)
	{
		v2_n0[cCells] = 1.0;
	}
...
{
	#pragma omp parallel for shared(v1_nplus1_kplus1)
	for (size_t cCells=0; cCells<nbCells; cCells++)
	{
...
{
	#pragma omp parallel for shared(v2_nplus1_kplus1)
	for (size_t cCells=0; cCells<nbCells; cCells++)
	{
...
{
	#pragma omp parallel for shared(v1_nplus1_k)
	for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
	{
		v1_nplus1_k[i1Cells] = v1_nplus1_k0[i1Cells];
	}
	#pragma omp parallel for shared(v2_nplus1_k)
	for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
	{
...
{
	t_n = t_n0;
	#pragma omp parallel for shared(v2_n)
	for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
	{
...
void Iteration::executeTimeLoopN() noexcept
{
	...
	do
	{
		...
		#pragma omp parallel for shared(v1_n)
		for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
		{
...
{
	#pragma omp parallel for shared(v1_nplus1)
	for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
	{
		v1_nplus1[i1Cells] = v1_nplus1_kplus1[i1Cells];
	}
	#pragma omp parallel for shared(v2_nplus1)
	for (size_t i1Cells=0; i1Cells<nbCells; i1Cells++)
	{
