...
public final class Affectations
{
	...
	protected void setUpTimeLoopN()
	{
		...
		{
			for (int i2=0 ; i2<e_n[i1].length ; i2++)
				e_n[i1][i2] = e_n0[i1][i2];
		});
	}
	...
	protected void setUpTimeLoopK()
	{
		...
		{
			for (int i2=0 ; i2<e2_nplus1_k[i1].length ; i2++)
				e2_nplus1_k[i1][i2] = e2_nplus1_k0[i1][i2];
		});
	}
	...
	protected void tearDownTimeLoopK()
	{
		...
		{
			for (int i2=0 ; i2<e2_nplus1[i1].length ; i2++)
				e2_nplus1[i1][i2] = e2_nplus1_kplus1[i1][i2];
		});
	}
