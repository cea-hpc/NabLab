...
public abstract class NablaMulNode extends NablaBinaryExpressionNode {
	...
	protected NV1Int mul(NV0Int left, Object right, @CachedLibrary("right") NV1IntLibrary arrays) {
	...
	@ExplodeLoop
	@Specialization(guards = "arrays.isArray(right)", limit = "3")
	protected NV1Real mul(NV0Real left, Object right, @CachedLibrary("right") NV1IntLibrary arrays) {
	...
	protected NV1Int mul(Object left, NV0Int right, @CachedLibrary("left") NV1IntLibrary arrays) {
	...
	@ExplodeLoop
	@Specialization(guards = "arrays.isArray(left)", limit = "3")
	protected NV1Real mul(Object left, NV0Real right, @CachedLibrary("left") NV1IntLibrary arrays) {
		final int length = arrays.length(left);
		final double rightData = right.getData();
	...
	protected NV1Int mul(Object left, Object right, //
	...
	@ExplodeLoop
	@Specialization(guards = "arrays.isArray(left)", limit = "3")
	protected NV1Real mul(Object left, NV1Real right, //
	...
	@ExplodeLoop
	@Specialization(guards = "arrays.isArray(right)", limit = "3")
	protected NV1Real mul(NV1Real left, Object right, //
	...
	protected NV1Real mul(NV1Real left, NV1Real right, @Cached("left.getData().length") int cachedCount) {
		final double[] leftData = left.getData();
		final double[] rightData = right.getData();
