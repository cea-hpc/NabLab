...
{
	{
		...
		Kokkos::parallel_for(nbTopCells, KOKKOS_LAMBDA(const size_t& tcTopCells)
		{
	...
	}
	{
		...
		Kokkos::parallel_for(nbBottomCells, KOKKOS_LAMBDA(const size_t& bcBottomCells)
		{
	...
	}
	{
		...
		Kokkos::parallel_for(nbLeftCells, KOKKOS_LAMBDA(const size_t& lcLeftCells)
		{
	...
	}
	{
		...
		Kokkos::parallel_for(nbRightCells, KOKKOS_LAMBDA(const size_t& rcRightCells)
		{
...
{
	{
		...
		Kokkos::parallel_for(nbCompletelyInnerVerticalFaces, KOKKOS_LAMBDA(const size_t& civfCompletelyInnerVerticalFaces)
		{
...
{
	{
		...
		Kokkos::parallel_for(nbCompletelyInnerHorizontalFaces, KOKKOS_LAMBDA(const size_t& cihfCompletelyInnerHorizontalFaces)
		{
...
{
	{
		...
		Kokkos::parallel_for(nbInnerCells, KOKKOS_LAMBDA(const size_t& cInnerCells)
		{
